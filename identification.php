...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" action="verification_identifiant.php" method="post">
        <h3 class="form-title"> Connexion</h3>
        <div class="alert alert-danger display-hide">
            <button class="close" data-close="alert"></button>
            <span> Entrer vos identifiants  </span>
        </div>
        <div class="form-group">
            <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
            <label class="control-label visible-ie8 visible-ie9">Pseudo</label>
            <div class="input-icon">
                <i class="fa fa-user"></i>
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Pseudo" name="Pseudo" /> </div>
        </div>
        <div class="form-group">
