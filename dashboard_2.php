                            ...
                            <div class="portlet light ">
                                <div class="portlet-title tabbable-line">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark bold uppercase">test</span>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="easy-pie-chart">
                                                <div class="number transactions" data-percent="
                                                <?php
                                                    $tempstt = $donnees['tempstt'];
                                                    $temps=$donnees['temps'];
                                                ...
                                                <a class="title" href="taches.php?id=
                                                <?php
                                                echo $donnees['idProjets'];
